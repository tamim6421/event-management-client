...
const InfoCard = ({info, usersInfo, setUsersInfo}) => {
  ...
  <div className="hero-content flex-col lg:flex-row bg-rose-50">
    <img src={photo} className="rounded-lg shadow-2xl mr-5 max-w-[350px] h-[500px]" data-aos="fade-up" />
...
He bent and kissed his newborn daughter on the brow, his heart full of love and gratitude.</p>
      ...
      <button onClick={() =>handleDelete(_id)} className="btn bg-rose-200 " data-aos="fade-down" ><AiFillDelete className="text-red-500 text-3xl"></AiFillDelete></button>
...
<button onClick={handleBack} className="btn bg-rose-200 text-xl text-orange-500"  data-aos="fade-up" >back</button>
      </div>
